        ...
        >
          ...
          {isFarm ? (
            <Box sx={{ mt: "20px" }}>
              ...
              <Box>Multiplier({multiplier}x)</Box>
              <Box>
                <TextField
                  value={multiplier}
              ...
              <Box>Rewards Per Block: {rewardBlock}</Box>
              <Box sx={{ py: "10px" }}>
